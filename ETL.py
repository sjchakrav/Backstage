...
df['date_of_death'] = df.apply(lambda x: pd.datetime.strptime("{0} {1} {2} 00:00:00".format(x['year_date_of_death'],x['month_date_of_death'], x['day_date_of_death']), "%Y %m %d %H:%M:%S"),axis=1)
